      ...
      <header className="bg-[#333] text-white py-10 text-center">
        <div>
          ...
          <h2 className="text-xl mt-2">
            Primeira atividade utilizando TypeScript e Tailwind CSS
          </h2>
        </div>
      </header>
      ...
      <main>
        ...
        >
          ...
          <p className="leading-relaxed">
            ...
            do TypeScript utilizando tags semânticas. O objetivo é
            demonstrar o uso de elementos como header, nav,
            main, section, article e footer.com o auxílio do 
